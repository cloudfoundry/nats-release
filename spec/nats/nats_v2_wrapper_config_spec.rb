      ...
      describe 'nats job' do
        ...
        it 'renders the template with the provided manifest properties' do
          ...
          expected_template = {
            ...
            "nats_v2_wrapper_server_ca_file" => "/var/vcap/jobs/nats/config/internal_tls/ca.pem",
            "nats_v2_wrapper_server_cert_file" => "/var/vcap/jobs/nats/config/internal_tls/certificate.pem",
            "nats_v2_wrapper_server_key_file" => "/var/vcap/jobs/nats/config/internal_tls/private_key.pem",
